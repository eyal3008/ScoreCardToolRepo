...
//         $scope.FtrnResReady = true;
//         var dataArray = ["Ftr",FtrScore*100,"Resolution",ResScore*100];
//       UpdateOnDBMulti(dataArray, CurrentMonthInString, $rootScope.activeUser.user.Name);
//
//
//     }
//
...
//
//         //cast name
//         var engineernamecasted = CastName($rootScope.activeUser.user.Name);
//
//         //get current date
//         var DatesArray = GetDate();
//         var i = 1;
...
//
//
//                 var x = CalculateEngineerClosedTickets($rootScope.activeUser.user.Name, testarray);
//
//                 var ImArray = Parser(x, 'I', CurrentMonth, CastName($rootScope.activeUser.user.Name));
//                 //    var SrArray = Parser(x, 'S', CurrentMonth, CastName($rootScope.activeUser.user.Name));
//                 //calculate IMs per day
//
//
...
//                 //  UpdateImsPerDayOnDB($scope.IMSPerDay, SelectedMonth, $rootScope.activeUser.user.Name);
//                 console.log(CurrentMonthInString);
//                 UpdateOnDB($scope.IMSPerDay, CurrentMonthInString, $rootScope.activeUser.user.Name, "Im")
//                 //UpdateOnDB($scope.SrSPerDay, CurrentMonthInString, $rootScope.activeUser.user.Name,"Sr")
//
//             });
//     }
...
//                 console.log(response);
//
//                 var NewName = CastName($rootScope.activeUser.user.Name);
//                 var EngineerTickets = response.filter(ticket => ticket.field2 == NewName);
//                 console.log(EngineerTickets);
//                 console.log(EngineerTickets[3][monthOnReport]);
//
...
//                     EngineerTickets[3][monthOnReport] = 0;
//
//                     UpdateOnDB(EngineerTickets[3][monthOnReport], CurrentMonthInString, $rootScope.activeUser.user.Name, "Update")
//
//                 } else {
//                     UpdateOnDB(EngineerTickets[3][monthOnReport], CurrentMonthInString, $rootScope.activeUser.user.Name, "Update")
//                 }
...
//
//
//         CalcSurvey($rootScope.activeUser.user.Name); //  your code here
//
//
//     }
//
...
//
//
//                            CalculateEngineerFtrAndRes($rootScope.activeUser.user.Name, testarray);
//
//
//
//                           //UpdateOnDB($scope.SrSPerDay, CurrentMonthInString, $rootScope.activeUser.user.Name,"Sr")
